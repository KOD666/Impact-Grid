...
const initialVolunteers: Volunteer[] = [
  ...
  },
  {
    ...
    joined_at: "2024-05-10",
    contact_email: "e.vasquez@impactgrid.ops",
  ...
  },
  {
    ...
    name: "DR. OMAR HASSAN",
    location: "Houston, TX",
    skills: ["medical", "surgery", "trauma"],
    availability: "available",
    clearance_level: 5,
    missions_completed: 44,
    coordinates: { lat: 29.7604, lng: -95.3698 },
    joined_at: "2023-02-14",
    contact_email: "o.hassan@impactgrid.ops",
    contact_phone: "+1-555-0602",
    mission_history: [],
  },
  {
    id: "v-08",
    name: "TECH. PRIYA NAIR",
    location: "Seattle, WA",
    skills: ["engineering", "electrical", "comms"],
    availability: "available",
    clearance_level: 3,
    missions_completed: 8,
    coordinates: { lat: 47.6062, lng: -122.3321 },
    joined_at: "2024-07-01",
    contact_email: "p.nair@impactgrid.ops",
    contact_phone: "+1-555-0703",
    mission_history: [],
  },
  {
    id: "v-09",
    name: "CPT. LUCAS FERREIRA",
    location: "Miami, FL",
    skills: ["logistics", "driving", "security"],
    availability: "available",
    clearance_level: 4,
    missions_completed: 31,
    coordinates: { lat: 25.7617, lng: -80.1918 },
    joined_at: "2023-09-05",
    contact_email: "l.ferreira@impactgrid.ops",
    contact_phone: "+1-555-0804",
    mission_history: [],
  },
  {
    id: "v-10",
    name: "OP. ANYA KOWALSKI",
    location: "Chicago, IL",
    skills: ["recon", "communication", "navigation"],
    availability: "available",
    clearance_level: 4,
    missions_completed: 19,
    coordinates: { lat: 41.8781, lng: -87.6298 },
    joined_at: "2024-02-20",
    contact_email: "a.kowalski@impactgrid.ops",
    contact_phone: "+1-555-0905",
    mission_history: [],
  },
  {
    id: "v-11",
    name: "MEDIC. JAMES OKAFOR",
    location: "Atlanta, GA",
    skills: ["medical", "first aid", "hazmat"],
    availability: "available",
    clearance_level: 3,
    missions_completed: 27,
    coordinates: { lat: 33.7490, lng: -84.3880 },
    joined_at: "2023-11-08",
    contact_email: "j.okafor@impactgrid.ops",
    contact_phone: "+1-555-1006",
    mission_history: [],
  },
  {
    id: "v-12",
    name: "ENG. SOFIA PETROV",
    location: "Denver, CO",
    skills: ["engineering", "water purification", "technical"],
    availability: "available",
    clearance_level: 3,
    missions_completed: 15,
    coordinates: { lat: 39.7392, lng: -104.9903 },
    joined_at: "2024-04-12",
    contact_email: "s.petrov@impactgrid.ops",
    contact_phone: "+1-555-1107",
    mission_history: [],
  },
  {
    id: "v-13",
    name: "SGT. KWAME ASANTE",
    location: "Dallas, TX",
    skills: ["security", "combat", "driving"],
    availability: "busy",
    clearance_level: 4,
    ...
    contact_email: "k.asante@impactgrid.ops",
    contact_phone: "+1-555-1208",
    mission_history: ["MISSION-001"],
  },
  {
    id: "v-14",
    name: "COORD. ISABELLA ROMANO",
    ...
    contact_email: "i.romano@impactgrid.ops",
    contact_phone: "+1-555-1309",
    mission_history: [],
  },
  {
    id: "v-15",
    name: "TECH. RAVI SHANKAR",
    location: "San Jose, CA",
    skills: ["technical", "electrical", "engineering"],
    availability: "available",
    clearance_level: 3,
    missions_completed: 9,
    coordinates: { lat: 37.3382, lng: -121.8863 },
    joined_at: "2024-06-03",
    contact_email: "r.shankar@impactgrid.ops",
