...
const initialVolunteers: Volunteer[] = [
  ...
  },
  {
    ...
    skills: ["medical", "doctor", "trauma", "surgery"],
    availability: "busy",
    current_mission: "MSN-004",
    location: "Manila, Philippines",
    coordinates: { lat: 14.5995, lng: 120.9842 },
    missions_completed: 67,
    joined_at: "2023-05-22",
    contact_email: "s.reyes@impactgrid.ops",
    contact_phone: "+1-555-0767",
    mission_history: ["MSN-004"],
  },
  {
    id: "v8",
    name: "OP. MARCUS THORNE",
  ...
  },
  {
    ...
    skills: ["engineering", "water purification", "electrical", "technical"],
    availability: "busy",
    current_mission: "MSN-002",
    location: "Chengdu, China",
    coordinates: { lat: 30.5728, lng: 104.0668 },
    missions_completed: 28,
    joined_at: "2024-03-12",
    contact_email: "m.chen@impactgrid.ops",
    contact_phone: "+1-555-1028",
    mission_history: ["MSN-002"],
  },
  {
    id: "v11",
    name: "LT. AISHA KAMARA",
    skills: ["communications", "first aid", "rescue"],
    availability: "available",
    current_mission: undefined,
    location: "Freetown, Sierra Leone",
    coordinates: { lat: 8.4657, lng: -13.2317 },
    missions_completed: 14,
    joined_at: "2024-04-30",
    contact_email: "a.kamara@impactgrid.ops",
    contact_phone: "+1-555-1114",
    mission_history: [],
  },
  {
    id: "v12",
    name: "ENG. PAVEL NOVAK",
    skills: ["engineering", "logistics", "hazmat"],
    availability: "available",
    current_mission: undefined,
    ...
    contact_email: "p.novak@impactgrid.ops",
    contact_phone: "+1-555-1222",
    mission_history: [],
  },
  {
    id: "v13",
    name: "MEDIC. ROSA IBARRA",
    skills: ["medical", "trauma", "first aid"],
    availability: "busy",
    current_mission: "MSN-001",
    location: "Mexico City, Mexico",
    coordinates: { lat: 19.4326, lng: -99.1332 },
    missions_completed: 31,
    joined_at: "2023-12-25",
    contact_email: "r.ibarra@impactgrid.ops",
    contact_phone: "+1-555-1331",
    mission_history: ["MSN-001"],
  },
  {
    id: "v14",
    name: "OP. TARIQ AL-FARSI",
    skills: ["security", "driving", "rescue"],
    availability: "available",
    current_mission: undefined,
    location: "Muscat, Oman",
    coordinates: { lat: 23.5880, lng: 58.3829 },
    missions_completed: 9,
    joined_at: "2024-05-02",
    contact_email: "t.alfarsi@impactgrid.ops",
    contact_phone: "+1-555-1409",
    mission_history: [],
  },
  {
    id: "v15",
    name: "COORD. YUKI TANAKA",
    skills: ["logistics", "communications", "planning"],
    availability: "available",
    current_mission: undefined,
    ...
    contact_email: "y.tanaka@impactgrid.ops",
    contact_phone: "+1-555-1547",
    mission_history: [],
  },
]
