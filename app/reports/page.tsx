...
export default function ReportsPage() {
  ...
  const handleDownloadPDF = async (autoTrigger = false) => {
    ...
    try {
      ...
      const reportContent = `
================================================================================
IMPACTGRID — FIELD REPORT ANALYSIS
...
KEY_FINDINGS
================================================================================
${currentSummary.key_findings.map((f, i) => `${i + 1}. ${f}`).join("\n")}

================================================================================
IMMEDIATE_ACTIONS_REQUIRED
================================================================================
${currentSummary.immediate_actions_required.map((a, i) => `${i + 1}. ${a}`).join("\n")}

================================================================================
STATISTICS
================================================================================
Affected Population: ${currentSummary.affected_population}
Confidence Score: ${currentSummary.confidence_score}%

================================================================================
RESOURCES_REQUIRED
================================================================================
${currentSummary.resources_required.map((r) => `• ${r}`).join("\n")}

================================================================================
Generated by ImpactGrid Crisis Coordination Platform
================================================================================
      `.trim()
      ...
      link.href = url
      link.download = `ImpactGrid_Report_${new Date().toISOString().split('T')[0]}_${Math.random().toString(36).substr(2, 9)}.txt`
